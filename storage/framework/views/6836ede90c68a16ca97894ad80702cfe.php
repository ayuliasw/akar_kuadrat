        ...
        <div class="row">
            ...
            <div class="col-md-6" style="width: 300px;">
                <form method="GET" action="<?php echo e(route('api.result')); ?>">
                    ...
                    <input type="number" id="apiNumber" name="number" class="form-control" required min="0" step="any">
            ...
            <div class="col-md-6" style="width: 300px;">
                <form method="POST" action="<?php echo e(route('execute.stored.procedure')); ?>">
                    ...
                    <input type="number" id="sqlNumber" name="number" class="form-control" required min="0" step="any">
                    <div class="d-flex align-items-center justify-content-between mt-3">
...
<?php /**PATH /Users/ayuliasetiawati/Downloads/test_ppl_last/resources/views/api_form.blade.php ENDPATH**/ ?>